        ...
        <BaseTooltip.Positioner sideOffset={sideOffset} side={side} align={align} className="z-50">
          <BaseTooltip.Popup
            ...
            className={cn(
              ...
              "oc-glass-tooltip oc-motion-overlay-tooltip text-[var(--surface-elevated-foreground)] border border-border/60 data-[instant]:transition-none z-50 w-fit origin-[var(--transform-origin)] rounded-xl px-3 py-1.5 typography-meta text-balance overflow-hidden",
              className
            )}
            style={{ ...style }}
            {...props}
