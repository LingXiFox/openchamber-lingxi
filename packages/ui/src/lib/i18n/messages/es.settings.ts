...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.usage.page.state.sub2ApiNoModelTitle": "No hay un modelo Sub2API seleccionado",
  "settings.usage.page.state.sub2ApiNoModelDescription": "Cambia a un modelo cuyo proveedor de OpenCode tenga una asignación de Sub2API en quota/sub2api.json para ver su saldo.",
  ...
  "settings.openchamber.visual.background.title": "Fondo del espacio de trabajo",
  "settings.openchamber.visual.background.description": "Usa una imagen local detrás de este espacio de trabajo. La imagen permanece en este dispositivo.",
  "settings.openchamber.visual.background.image": "Imagen de fondo",
  "settings.openchamber.visual.background.choose": "Elegir imagen",
  "settings.openchamber.visual.background.replace": "Reemplazar imagen",
  "settings.openchamber.visual.background.remove": "Eliminar",
  "settings.openchamber.visual.background.error": "No se pudo actualizar el fondo del espacio de trabajo.",
  "settings.openchamber.visual.background.opacity": "Opacidad de los paneles",
  "settings.openchamber.visual.background.readability": "Legibilidad",
  "settings.openchamber.visual.background.readability.weak": "Baja",
  "settings.openchamber.visual.background.readability.standard": "Estándar",
  "settings.openchamber.visual.background.readability.strong": "Alta",
  "settings.openchamber.visual.background.blur": "Desenfocar paneles",
  "settings.openchamber.visual.background.fit": "Ajuste de imagen",
  "settings.openchamber.visual.background.fit.cover": "Cubrir",
  "settings.openchamber.visual.background.fit.contain": "Contener",
  "settings.openchamber.visual.background.position": "Posición",
  "settings.openchamber.visual.background.position.center": "Centro",
  "settings.openchamber.visual.background.position.top": "Arriba",
  "settings.openchamber.visual.background.position.bottom": "Abajo",
  "settings.openchamber.visual.background.position.left": "Izquierda",
  "settings.openchamber.visual.background.position.right": "Derecha",
