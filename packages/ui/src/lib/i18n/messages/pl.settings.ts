...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.openchamber.visual.background.title': 'Tło obszaru roboczego',
  'settings.openchamber.visual.background.description': 'Użyj lokalnego obrazu za tym obszarem roboczym. Obraz pozostaje na tym urządzeniu.',
  'settings.openchamber.visual.background.image': 'Obraz tła',
  'settings.openchamber.visual.background.choose': 'Wybierz obraz',
  'settings.openchamber.visual.background.replace': 'Zmień obraz',
  'settings.openchamber.visual.background.remove': 'Usuń',
  'settings.openchamber.visual.background.error': 'Nie udało się zaktualizować tła obszaru roboczego.',
  'settings.openchamber.visual.background.opacity': 'Krycie paneli',
  'settings.openchamber.visual.background.readability': 'Czytelność',
  'settings.openchamber.visual.background.readability.weak': 'Niska',
  'settings.openchamber.visual.background.readability.standard': 'Standardowa',
  'settings.openchamber.visual.background.readability.strong': 'Wysoka',
  'settings.openchamber.visual.background.blur': 'Rozmyj panele',
  'settings.openchamber.visual.background.fit': 'Dopasowanie obrazu',
  'settings.openchamber.visual.background.fit.cover': 'Wypełnij',
  'settings.openchamber.visual.background.fit.contain': 'Dopasuj',
  'settings.openchamber.visual.background.position': 'Pozycja',
  'settings.openchamber.visual.background.position.center': 'Środek',
  'settings.openchamber.visual.background.position.top': 'Góra',
  'settings.openchamber.visual.background.position.bottom': 'Dół',
  'settings.openchamber.visual.background.position.left': 'Lewa',
  'settings.openchamber.visual.background.position.right': 'Prawa',
