...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.graph.patches': '补丁',
  'gitView.graph.syncGroup': '同步（{count}）',
  'gitView.graph.stackGroup': '补丁栈（{count}）',
  'gitView.graph.stackGroupNamed': '{name} 栈（{count}）',
  'gitView.graph.anchor.mergeBase': '合并基点',
  'gitView.graph.anchor.release': '发布版本',
  'gitView.health.baseStale': '基底过期',
  'gitView.health.behind': '落后',
  'gitView.health.diverged': '已分叉',
  'gitView.health.dormant': '长期未动',
  'gitView.stacks.title': '补丁栈',
  'gitView.stacks.createWorktreeAria': '为 {branch} 创建工作树',
  'gitView.rebasePlan.title': 'Rebase 影响',
  'gitView.rebasePlan.uniqueCommits': '独有提交（{count}）',
  'gitView.rebasePlan.downstream': '下游补丁（{count}）',
  'gitView.rebasePlan.dependsOn': '{branch} 依赖 {parent}',
  'gitView.rebasePlan.failed': '无法加载 Rebase 影响。',
  'gitView.rebasePlan.warning.downstream': '改写此分支会让下游补丁继续基于旧历史。',
  'gitView.rebasePlan.warning.dirty': 'Rebase 前请提交或暂存工作区更改。',
  'gitView.rebasePlan.warning.noCommits': '此分支没有可 Rebase 的独有提交。',
  'gitView.rebasePlan.warning.unrelated': '此分支与目标分支没有共同祖先。',
  'gitView.precheck.checking': '正在检查冲突…',
  'gitView.precheck.clean': '无冲突',
  'gitView.precheck.conflicts': '{count} 个冲突文件',
  'gitView.precheck.failed': '冲突预检失败',
  'gitView.health.merged': '已合并',
  'gitView.health.summary': '{diverged} 个分叉 · {baseStale} 个基底过期 · {dormant} 个长期未动',
  'gitView.health.unrelated': '无关历史',
  'gitView.release.prereleaseLine': '预发布：{tag}',
  'gitView.release.prereleaseWithStable': '预发布：{tag} · 正式：{stableTag}',
  'gitView.release.snapshot': '无版本标签 — 快照状态',
  'gitView.release.stableLine': '正式版：{tag} · 分支 +{ahead}/-{behind}',
  'gitView.trace.active': '溯源模式已开启 — 点击提交开始追踪',
  'gitView.trace.clear': '清除溯源',
  'gitView.trace.containedIn': '包含于：{refs}',
  'gitView.trace.ancestorsTruncated': '共 {count} 个祖先（显示前 {shown} 个）',
  'gitView.trace.ancestorsCount': '{count} 个祖先',
  'gitView.trace.inHead': '已包含在当前 HEAD 中',
  'gitView.trace.loading': '追踪中…',
  ...
  'gitView.integrate.firstStepPrecheck': '首步预检',
  'gitView.integrate.fullSequenceNotSimulated': '全序列未模拟',
  ...
  'chat.statusRow.activity.connecting': '正在连接',
  'chat.statusRow.activity.retrying': '正在重试',
  'chat.statusRow.activity.listening': '正在聆听',
  'chat.statusRow.activity.working': '正在处理',
  'chat.statusRow.activity.searching': '正在搜索',
  'chat.statusRow.activity.reasoning': '正在推理',
  'chat.statusRow.activity.composing': '正在撰写',
  'chat.statusRow.activity.editing': '正在编辑',
  'chat.statusRow.activity.orchestrating': '正在委派任务',
