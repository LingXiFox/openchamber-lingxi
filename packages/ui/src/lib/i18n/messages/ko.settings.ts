...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.visual.background.title': '작업 공간 배경',
  'settings.openchamber.visual.background.description': '이 작업 공간 뒤에 로컬 이미지를 표시합니다. 이미지는 이 기기에만 저장됩니다.',
  'settings.openchamber.visual.background.image': '배경 이미지',
  'settings.openchamber.visual.background.choose': '이미지 선택',
  'settings.openchamber.visual.background.replace': '이미지 교체',
  'settings.openchamber.visual.background.remove': '제거',
  'settings.openchamber.visual.background.error': '작업 공간 배경을 업데이트하지 못했습니다.',
  'settings.openchamber.visual.background.opacity': '패널 불투명도',
  'settings.openchamber.visual.background.readability': '가독성',
  'settings.openchamber.visual.background.readability.weak': '약하게',
  'settings.openchamber.visual.background.readability.standard': '표준',
  'settings.openchamber.visual.background.readability.strong': '강하게',
  'settings.openchamber.visual.background.blur': '패널 흐리게',
  'settings.openchamber.visual.background.fit': '이미지 맞춤',
  'settings.openchamber.visual.background.fit.cover': '채우기',
  'settings.openchamber.visual.background.fit.contain': '맞추기',
  'settings.openchamber.visual.background.position': '위치',
  'settings.openchamber.visual.background.position.center': '가운데',
  'settings.openchamber.visual.background.position.top': '위',
  'settings.openchamber.visual.background.position.bottom': '아래',
  'settings.openchamber.visual.background.position.left': '왼쪽',
  'settings.openchamber.visual.background.position.right': '오른쪽',
