...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.statusRow.activity.retrying': 'Tentando novamente',
  'chat.statusRow.activity.listening': 'Ouvindo',
  'chat.statusRow.activity.working': 'Trabalhando',
  'chat.statusRow.activity.searching': 'Pesquisando',
  'chat.statusRow.activity.reasoning': 'Raciocinando',
  'chat.statusRow.activity.composing': 'Redigindo',
  'chat.statusRow.activity.editing': 'Editando',
  'chat.statusRow.activity.orchestrating': 'Delegando tarefa',
  ...
  'gitView.graph.raw': 'Bruto',
  'gitView.graph.patches': 'Patches',
  'gitView.graph.syncGroup': 'Sincronização ({count})',
  'gitView.graph.stackGroup': 'Pilha de patches ({count})',
  'gitView.graph.stackGroupNamed': 'Pilha {name} ({count})',
  'gitView.graph.anchor.mergeBase': 'Base de merge',
  'gitView.graph.anchor.release': 'Versão',
  "gitView.health.baseStale": "base desatualizada",
  "gitView.health.behind": "atrasado",
  "gitView.health.diverged": "divergido",
  "gitView.health.dormant": "inativo",
  "gitView.stacks.title": "Pilhas de patches",
  "gitView.stacks.createWorktreeAria": "Criar worktree para {branch}",
  'gitView.rebasePlan.title': 'Impacto do rebase',
  'gitView.rebasePlan.uniqueCommits': 'Commits exclusivos ({count})',
  'gitView.rebasePlan.downstream': 'Patches posteriores ({count})',
  'gitView.rebasePlan.dependsOn': '{branch} depende de {parent}',
  'gitView.rebasePlan.failed': 'Não foi possível carregar o impacto do rebase.',
  'gitView.rebasePlan.warning.downstream': 'Reescrever esta branch deixará os patches posteriores baseados no histórico antigo.',
  'gitView.rebasePlan.warning.dirty': 'Faça commit ou stash das alterações antes do rebase.',
  'gitView.rebasePlan.warning.noCommits': 'Esta branch não tem commits exclusivos para rebase.',
  'gitView.rebasePlan.warning.unrelated': 'A branch e o destino não têm um ancestral comum.',
  'gitView.precheck.checking': 'Verificando conflitos…',
  'gitView.precheck.clean': 'Sem conflitos',
  'gitView.precheck.conflicts': '{count} arquivos em conflito',
  'gitView.precheck.failed': 'Falha na pré-verificação de conflitos',
  "gitView.health.merged": "mesclado",
  "gitView.health.summary": "{diverged} divergidos · {baseStale} bases desatualizadas · {dormant} inativos",
  "gitView.health.unrelated": "histórico sem relação",
  "gitView.release.prereleaseLine": "Pré-lançamento: {tag}",
  "gitView.release.prereleaseWithStable": "Pré-lançamento: {tag} · Estável: {stableTag}",
  "gitView.release.snapshot": "Sem tags de versão — snapshot",
  "gitView.release.stableLine": "Estável: {tag} · branch +{ahead}/-{behind}",
  "gitView.trace.active": "Modo de rastreamento ativo — clique em um commit para rastrear",
  "gitView.trace.clear": "Limpar rastreamento",
  "gitView.trace.containedIn": "Contido em: {refs}",
  "gitView.trace.ancestorsTruncated": "{count} ancestrais (mostrando os primeiros {shown})",
  "gitView.trace.ancestorsCount": "{count} ancestrais",
  "gitView.trace.inHead": "Incluído no HEAD atual",
  "gitView.trace.loading": "Rastreando…",
  "gitView.trace.notContained": "Não está em nenhum branch local",
  "gitView.trace.toggle": "Modo de rastreamento",
  ...
  "gitView.integrate.firstStepPrecheck": "Pré-verificação do primeiro passo",
  "gitView.integrate.fullSequenceNotSimulated": "Sequência completa não simulada",
