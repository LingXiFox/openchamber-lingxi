...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.visual.background.title": "Тло робочого простору",
  "settings.openchamber.visual.background.description": "Використовуйте локальне зображення позаду цього робочого простору. Воно залишається на цьому пристрої.",
  "settings.openchamber.visual.background.image": "Фонове зображення",
  "settings.openchamber.visual.background.choose": "Вибрати зображення",
  "settings.openchamber.visual.background.replace": "Замінити зображення",
  "settings.openchamber.visual.background.remove": "Видалити",
  "settings.openchamber.visual.background.error": "Не вдалося оновити тло робочого простору.",
  "settings.openchamber.visual.background.opacity": "Непрозорість панелей",
  "settings.openchamber.visual.background.readability": "Читабельність",
  "settings.openchamber.visual.background.readability.weak": "Низька",
  "settings.openchamber.visual.background.readability.standard": "Стандартна",
  "settings.openchamber.visual.background.readability.strong": "Висока",
  "settings.openchamber.visual.background.blur": "Розмивати панелі",
  "settings.openchamber.visual.background.fit": "Масштабування зображення",
  "settings.openchamber.visual.background.fit.cover": "Заповнити",
  "settings.openchamber.visual.background.fit.contain": "Умістити",
  "settings.openchamber.visual.background.position": "Положення",
  "settings.openchamber.visual.background.position.center": "По центру",
  "settings.openchamber.visual.background.position.top": "Угорі",
  "settings.openchamber.visual.background.position.bottom": "Унизу",
  "settings.openchamber.visual.background.position.left": "Ліворуч",
  "settings.openchamber.visual.background.position.right": "Праворуч",
