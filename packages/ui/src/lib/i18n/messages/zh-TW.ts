...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.graph.raw': '原始',
  'gitView.graph.patches': '修補程式',
  'gitView.graph.syncGroup': '同步（{count}）',
  'gitView.graph.stackGroup': '修補程式堆疊（{count}）',
  'gitView.graph.stackGroupNamed': '{name} 堆疊（{count}）',
  'gitView.graph.anchor.mergeBase': '合併基點',
  'gitView.graph.anchor.release': '發行版本',
  'gitView.health.baseStale': '基底過期',
  'gitView.health.behind': '落後',
  'gitView.health.diverged': '已分叉',
  'gitView.health.dormant': '長期未動',
  'gitView.stacks.title': '修補程式堆疊',
  'gitView.stacks.createWorktreeAria': '為 {branch} 建立工作樹',
  'gitView.rebasePlan.title': 'Rebase 影響',
  'gitView.rebasePlan.uniqueCommits': '獨有提交（{count}）',
  'gitView.rebasePlan.downstream': '下游修補程式（{count}）',
  'gitView.rebasePlan.dependsOn': '{branch} 依賴 {parent}',
  'gitView.rebasePlan.failed': '無法載入 Rebase 影響。',
  'gitView.rebasePlan.warning.downstream': '改寫此分支會讓下游修補程式繼續基於舊歷史。',
  'gitView.rebasePlan.warning.dirty': 'Rebase 前請提交或暫存工作區變更。',
  'gitView.rebasePlan.warning.noCommits': '此分支沒有可 Rebase 的獨有提交。',
  'gitView.rebasePlan.warning.unrelated': '此分支與目標分支沒有共同祖先。',
  'gitView.precheck.checking': '正在檢查衝突…',
  'gitView.precheck.clean': '無衝突',
  'gitView.precheck.conflicts': '{count} 個衝突檔案',
  'gitView.precheck.failed': '衝突預檢失敗',
  'gitView.health.merged': '已合併',
  'gitView.health.summary': '{diverged} 個分叉 · {baseStale} 個基底過期 · {dormant} 個長期未動',
  'gitView.health.unrelated': '無關歷史',
  'gitView.release.prereleaseLine': '預發布：{tag}',
  'gitView.release.prereleaseWithStable': '預發布：{tag} · 正式：{stableTag}',
  'gitView.release.snapshot': '無版本標籤 — 快照狀態',
  'gitView.release.stableLine': '正式版：{tag} · 分支 +{ahead}/-{behind}',
  'gitView.trace.active': '溯源模式已開啟 — 點擊提交開始追蹤',
  'gitView.trace.clear': '清除溯源',
  'gitView.trace.containedIn': '包含於:{refs}',
  'gitView.trace.ancestorsTruncated': '共 {count} 個祖先（顯示前 {shown} 個）',
  'gitView.trace.ancestorsCount': '{count} 個祖先',
  'gitView.trace.inHead': '已包含在目前 HEAD 中',
  'gitView.trace.loading': '追蹤中…',
  'gitView.trace.notContained': '不在任何本地分支上',
  'gitView.trace.toggle': '溯源模式',
  ...
  'gitView.integrate.firstStepPrecheck': '首步預檢',
  'gitView.integrate.fullSequenceNotSimulated': '全序列未模擬',
  ...
  'chat.statusRow.activity.connecting': '正在連線',
  'chat.statusRow.activity.retrying': '正在重試',
  'chat.statusRow.activity.listening': '正在聆聽',
  'chat.statusRow.activity.working': '正在處理',
  'chat.statusRow.activity.searching': '正在搜尋',
  'chat.statusRow.activity.reasoning': '正在推理',
  'chat.statusRow.activity.composing': '正在撰寫',
  'chat.statusRow.activity.editing': '正在編輯',
  'chat.statusRow.activity.orchestrating': '正在委派任務',
