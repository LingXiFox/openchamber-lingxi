...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.graph.raw': 'Original',
  'gitView.graph.patches': 'Parches',
  'gitView.graph.syncGroup': 'Sincronización ({count})',
  'gitView.graph.stackGroup': 'Pila de parches ({count})',
  'gitView.graph.stackGroupNamed': 'Pila {name} ({count})',
  'gitView.graph.anchor.mergeBase': 'Base de fusión',
  'gitView.graph.anchor.release': 'Versión',
  "gitView.health.baseStale": "base obsoleta",
  "gitView.health.behind": "rezagada",
  "gitView.health.diverged": "divergida",
  "gitView.health.dormant": "inactiva",
  "gitView.stacks.title": "Pilas de parches",
  "gitView.stacks.createWorktreeAria": "Crear worktree para {branch}",
  'gitView.rebasePlan.title': 'Impacto del rebase',
  'gitView.rebasePlan.uniqueCommits': 'Commits únicos ({count})',
  'gitView.rebasePlan.downstream': 'Parches posteriores ({count})',
  'gitView.rebasePlan.dependsOn': '{branch} depende de {parent}',
  'gitView.rebasePlan.failed': 'No se pudo cargar el impacto del rebase.',
  'gitView.rebasePlan.warning.downstream': 'Reescribir esta rama dejará los parches posteriores basados en el historial anterior.',
  'gitView.rebasePlan.warning.dirty': 'Confirma o guarda los cambios del árbol de trabajo antes del rebase.',
  'gitView.rebasePlan.warning.noCommits': 'Esta rama no tiene commits únicos para reorganizar.',
  "gitView.rebasePlan.warning.unrelated": "La rama y el destino no comparten un ancestro común.",
  "gitView.precheck.checking": "Comprobando conflictos…",
  "gitView.precheck.clean": "Sin conflictos",
  "gitView.precheck.conflicts": "{count} archivos en conflicto",
  "gitView.precheck.failed": "La comprobación previa de conflictos falló",
  "gitView.health.merged": "fusionada",
  "gitView.health.summary": "{diverged} divergidas · {baseStale} bases obsoletas · {dormant} inactivas",
  "gitView.health.unrelated": "historial sin relación",
  "gitView.release.prereleaseLine": "Prelanzamiento: {tag}",
  "gitView.release.prereleaseWithStable": "Prelanzamiento: {tag} · Estable: {stableTag}",
  "gitView.release.snapshot": "Sin etiquetas de versión — instantánea",
  "gitView.release.stableLine": "Estable: {tag} · rama +{ahead}/-{behind}",
  "gitView.trace.active": "Modo de trazado activo — haz clic en un commit para rastrearlo",
  "gitView.trace.clear": "Borrar trazado",
  "gitView.trace.containedIn": "Contenido en: {refs}",
  "gitView.trace.ancestorsTruncated": "{count} antecesores (mostrando los primeros {shown})",
  "gitView.trace.ancestorsCount": "{count} antecesores",
  "gitView.trace.inHead": "Incluido en el HEAD actual",
  "gitView.trace.loading": "Rastreando…",
  "gitView.trace.notContained": "No está en ninguna rama local",
  "gitView.trace.toggle": "Modo de trazado",
  ...
  "gitView.integrate.firstStepPrecheck": "Preverificación del primer paso",
  "gitView.integrate.fullSequenceNotSimulated": "Secuencia completa no simulada",
