...
export const settingsDict = {
  ...
  'settings.openchamber.worktrees.list.stackMembershipWithParent': '{group} · stacked on {parent}',
  ...
  'settings.openchamber.visual.background.title': 'Workspace background',
  'settings.openchamber.visual.background.description': 'Use a local image behind this workspace. The image stays on this device.',
  'settings.openchamber.visual.background.image': 'Background image',
  'settings.openchamber.visual.background.choose': 'Choose image',
  'settings.openchamber.visual.background.replace': 'Replace image',
  'settings.openchamber.visual.background.remove': 'Remove',
  'settings.openchamber.visual.background.error': 'Could not update the workspace background.',
  'settings.openchamber.visual.background.opacity': 'Panel opacity',
  'settings.openchamber.visual.background.readability': 'Readability',
  'settings.openchamber.visual.background.readability.weak': 'Weak',
  'settings.openchamber.visual.background.readability.standard': 'Standard',
  'settings.openchamber.visual.background.readability.strong': 'Strong',
  'settings.openchamber.visual.background.blur': 'Blur panels',
  'settings.openchamber.visual.background.fit': 'Image fit',
  'settings.openchamber.visual.background.fit.cover': 'Cover',
  'settings.openchamber.visual.background.fit.contain': 'Contain',
  'settings.openchamber.visual.background.position': 'Position',
  'settings.openchamber.visual.background.position.center': 'Center',
  'settings.openchamber.visual.background.position.top': 'Top',
  'settings.openchamber.visual.background.position.bottom': 'Bottom',
  'settings.openchamber.visual.background.position.left': 'Left',
  'settings.openchamber.visual.background.position.right': 'Right',
