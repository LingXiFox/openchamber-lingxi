...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.usage.page.state.sub2ApiNoModelTitle": "Nenhum modelo Sub2API selecionado",
  "settings.usage.page.state.sub2ApiNoModelDescription": "Troque para um modelo cujo provedor OpenCode tenha um mapeamento Sub2API em quota/sub2api.json para ver o saldo.",
  ...
  "settings.openchamber.worktrees.list.stackMembershipWithParent": "{group} · empilhado em {parent}",
  ...
  "settings.openchamber.visual.background.title": "Plano de fundo do espaço de trabalho",
  "settings.openchamber.visual.background.description": "Use uma imagem local atrás deste espaço de trabalho. A imagem permanece neste dispositivo.",
  "settings.openchamber.visual.background.image": "Imagem de fundo",
  "settings.openchamber.visual.background.choose": "Escolher imagem",
  "settings.openchamber.visual.background.replace": "Substituir imagem",
  "settings.openchamber.visual.background.remove": "Remover",
  "settings.openchamber.visual.background.error": "Não foi possível atualizar o plano de fundo do espaço de trabalho.",
  "settings.openchamber.visual.background.opacity": "Opacidade dos painéis",
  "settings.openchamber.visual.background.readability": "Legibilidade",
  "settings.openchamber.visual.background.readability.weak": "Baixa",
  "settings.openchamber.visual.background.readability.standard": "Padrão",
  "settings.openchamber.visual.background.readability.strong": "Alta",
  "settings.openchamber.visual.background.blur": "Desfocar painéis",
  "settings.openchamber.visual.background.fit": "Ajuste da imagem",
  "settings.openchamber.visual.background.fit.cover": "Cobrir",
  "settings.openchamber.visual.background.fit.contain": "Conter",
  "settings.openchamber.visual.background.position": "Posição",
  "settings.openchamber.visual.background.position.center": "Centro",
  "settings.openchamber.visual.background.position.top": "Topo",
  "settings.openchamber.visual.background.position.bottom": "Inferior",
  "settings.openchamber.visual.background.position.left": "Esquerda",
  "settings.openchamber.visual.background.position.right": "Direita",
