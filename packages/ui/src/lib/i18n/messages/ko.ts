...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.graph.raw': '원본',
  'gitView.graph.patches': '패치',
  'gitView.graph.syncGroup': '동기화({count})',
  'gitView.graph.stackGroup': '패치 스택({count})',
  'gitView.graph.stackGroupNamed': '{name} 스택({count})',
  'gitView.graph.anchor.mergeBase': '병합 기준',
  'gitView.graph.anchor.release': '릴리스',
  'gitView.health.baseStale': '오래된 베이스',
  'gitView.health.behind': '뒤처짐',
  'gitView.health.diverged': '분기됨',
  'gitView.health.dormant': '장기 미활동',
  'gitView.stacks.title': '패치 스택',
  'gitView.stacks.createWorktreeAria': '{branch} 워크트리 생성',
  'gitView.rebasePlan.title': '리베이스 영향',
  'gitView.rebasePlan.uniqueCommits': '고유 커밋({count})',
  'gitView.rebasePlan.downstream': '다운스트림 패치({count})',
  'gitView.rebasePlan.dependsOn': '{branch}이(가) {parent}에 의존',
  'gitView.rebasePlan.failed': '리베이스 영향을 불러올 수 없습니다.',
  'gitView.rebasePlan.warning.downstream': '이 브랜치를 다시 쓰면 다운스트림 패치가 이전 기록을 계속 기반으로 합니다.',
  'gitView.rebasePlan.warning.dirty': '리베이스 전에 작업 트리 변경 사항을 커밋하거나 스태시하세요.',
  'gitView.rebasePlan.warning.noCommits': '이 브랜치에는 리베이스할 고유 커밋이 없습니다.',
  'gitView.rebasePlan.warning.unrelated': '브랜치와 대상에 공통 조상이 없습니다.',
  'gitView.precheck.checking': '충돌 확인 중…',
  'gitView.precheck.clean': '충돌 없음',
  'gitView.precheck.conflicts': '충돌 파일 {count}개',
  'gitView.precheck.failed': '충돌 사전 확인 실패',
  'gitView.health.merged': '병합됨',
  'gitView.health.summary': '분기 {diverged}개 · 오래된 베이스 {baseStale}개 · 장기 미활동 {dormant}개',
  'gitView.health.unrelated': '무관한 히스토리',
  'gitView.release.prereleaseLine': '프리릴리스: {tag}',
  'gitView.release.prereleaseWithStable': '프리릴리스: {tag} · 안정 버전: {stableTag}',
  'gitView.release.snapshot': '릴리스 태그 없음 — 스냅샷',
  'gitView.release.stableLine': '안정 버전: {tag} · 브랜치 +{ahead}/-{behind}',
  'gitView.trace.active': '추적 모드 켜짐 — 커밋을 클릭하여 추적',
  'gitView.trace.clear': '추적 지우기',
  'gitView.trace.containedIn': '포함된 브랜치: {refs}',
  'gitView.trace.ancestorsTruncated': '조상 {count}개（처음 {shown}개 표시）',
  'gitView.trace.ancestorsCount': '조상 {count}개',
  'gitView.trace.inHead': '현재 HEAD에 포함됨',
  'gitView.trace.loading': '추적 중…',
  'gitView.trace.notContained': '로컬 브랜치에 없음',
  'gitView.trace.toggle': '추적 모드',
  ...
  'gitView.integrate.firstStepPrecheck': '첫 단계 사전 확인',
  'gitView.integrate.fullSequenceNotSimulated': '전체 시퀀스 미시뮬레이션',
  ...
  'chat.statusRow.activity.connecting': '연결 중',
  'chat.statusRow.activity.retrying': '재시도 중',
  'chat.statusRow.activity.listening': '듣는 중',
  'chat.statusRow.activity.working': '작업 중',
  'chat.statusRow.activity.searching': '검색 중',
  'chat.statusRow.activity.reasoning': '추론 중',
  'chat.statusRow.activity.composing': '작성 중',
  'chat.statusRow.activity.editing': '편집 중',
  'chat.statusRow.activity.orchestrating': '작업 위임 중',
