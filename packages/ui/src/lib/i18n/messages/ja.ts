...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.graph.patches': 'パッチ',
  'gitView.graph.syncGroup': '同期（{count}）',
  'gitView.graph.stackGroup': 'パッチスタック（{count}）',
  'gitView.graph.stackGroupNamed': '{name} スタック（{count}）',
  'gitView.graph.anchor.mergeBase': 'マージベース',
  'gitView.graph.anchor.release': 'リリース',
  'gitView.health.baseStale': 'ベースが古い',
  'gitView.health.behind': '遅れ',
  'gitView.health.diverged': '分岐',
  'gitView.health.dormant': '長期間停止',
  'gitView.stacks.title': 'パッチスタック',
  'gitView.stacks.createWorktreeAria': '{branch} のワークツリーを作成',
  'gitView.rebasePlan.title': 'リベースの影響',
  'gitView.rebasePlan.uniqueCommits': '固有のコミット（{count}）',
  'gitView.rebasePlan.downstream': '下流パッチ（{count}）',
  'gitView.rebasePlan.dependsOn': '{branch} は {parent} に依存',
  'gitView.rebasePlan.failed': 'リベースの影響を読み込めませんでした。',
  'gitView.rebasePlan.warning.downstream': 'このブランチを書き換えると、下流パッチは古い履歴に基づいたままになります。',
  'gitView.rebasePlan.warning.dirty': 'リベース前に作業ツリーの変更をコミットまたはスタッシュしてください。',
  'gitView.rebasePlan.warning.noCommits': 'このブランチにはリベース対象の固有コミットがありません。',
  'gitView.rebasePlan.warning.unrelated': 'ブランチとターゲットに共通の祖先がありません。',
  'gitView.precheck.checking': '競合を確認中…',
  'gitView.precheck.clean': '競合なし',
  'gitView.precheck.conflicts': '競合ファイル {count} 件',
  'gitView.precheck.failed': '競合の事前チェックに失敗しました',
  'gitView.health.merged': 'マージ済み',
  'gitView.health.summary': '分岐 {diverged} · ベース古い {baseStale} · 長期停止 {dormant}',
  'gitView.health.unrelated': '無関係な履歴',
  'gitView.release.prereleaseLine': 'プレリリース:{tag}',
  'gitView.release.prereleaseWithStable': 'プレリリース:{tag} · 安定版:{stableTag}',
  'gitView.release.snapshot': 'リリースタグなし — スナップショット',
  'gitView.release.stableLine': '安定版:{tag} · ブランチ +{ahead}/-{behind}',
  'gitView.trace.active': 'トレースモード有効 — コミットをクリックして追跡',
  'gitView.trace.clear': 'トレースを解除',
  'gitView.trace.containedIn': '含まれるブランチ:{refs}',
  'gitView.trace.ancestorsTruncated': '祖先 {count} 件（先頭 {shown} 件を表示）',
  'gitView.trace.ancestorsCount': '祖先 {count} 件',
  'gitView.trace.inHead': '現在の HEAD に含まれています',
  'gitView.trace.loading': 'トレース中…',
  'gitView.trace.notContained': 'ローカルブランチに存在しません',
  'gitView.trace.toggle': 'トレースモード',
  ...
  'gitView.integrate.firstStepPrecheck': '初手の事前チェック',
  'gitView.integrate.fullSequenceNotSimulated': '全シーケンスは未シミュレーション',
  ...
  'chat.statusRow.activity.connecting': '接続中',
  'chat.statusRow.activity.retrying': '再試行中',
  'chat.statusRow.activity.listening': '聞き取り中',
  'chat.statusRow.activity.working': '処理中',
  'chat.statusRow.activity.searching': '検索中',
  'chat.statusRow.activity.reasoning': '推論中',
  'chat.statusRow.activity.composing': '作成中',
  'chat.statusRow.activity.editing': '編集中',
  'chat.statusRow.activity.orchestrating': 'タスクを委任中',
