...
export const dict = {
  ...
  'gitView.graph.raw': 'Raw',
  'gitView.graph.patches': 'Patches',
  'gitView.graph.syncGroup': 'Sync ({count})',
  'gitView.graph.stackGroup': 'Patch stack ({count})',
  'gitView.graph.stackGroupNamed': '{name} stack ({count})',
  'gitView.graph.anchor.mergeBase': 'Merge base',
  'gitView.graph.anchor.release': 'Release',
  'gitView.health.baseStale': 'stale base',
  'gitView.health.behind': 'behind',
  'gitView.health.diverged': 'diverged',
  'gitView.health.dormant': 'dormant',
  'gitView.stacks.title': 'Patch stacks',
  'gitView.stacks.createWorktreeAria': 'Create worktree for {branch}',
  'gitView.rebasePlan.title': 'Rebase impact',
  'gitView.rebasePlan.uniqueCommits': 'Unique commits ({count})',
  'gitView.rebasePlan.downstream': 'Downstream patches ({count})',
  'gitView.rebasePlan.dependsOn': '{branch} depends on {parent}',
  'gitView.rebasePlan.failed': 'Could not load rebase impact.',
  'gitView.rebasePlan.warning.downstream': 'Rewriting this branch will leave downstream patches based on the old history.',
  'gitView.rebasePlan.warning.dirty': 'Commit or stash working-tree changes before rebasing.',
  'gitView.rebasePlan.warning.noCommits': 'This branch has no unique commits to rebase.',
  'gitView.rebasePlan.warning.unrelated': 'The branch and target do not share a common ancestor.',
  'gitView.precheck.checking': 'Checking conflicts…',
  'gitView.precheck.clean': 'No conflicts',
  'gitView.precheck.conflicts': '{count} conflicting files',
  'gitView.precheck.failed': 'Conflict precheck failed',
  'gitView.health.merged': 'merged',
  'gitView.health.summary': '{diverged} diverged · {baseStale} stale base · {dormant} dormant',
  'gitView.health.unrelated': 'unrelated',
  'gitView.release.prereleaseLine': 'Prerelease: {tag}',
  'gitView.release.prereleaseWithStable': 'Prerelease: {tag} · Stable: {stableTag}',
  'gitView.release.snapshot': 'No release tags — snapshot',
  'gitView.release.stableLine': 'Stable: {tag} · branch +{ahead}/-{behind}',
  'gitView.trace.active': 'Trace mode on — click a commit to trace it',
  'gitView.trace.clear': 'Clear trace',
  'gitView.trace.containedIn': 'Contained in: {refs}',
  'gitView.trace.ancestorsTruncated': '{count} ancestors (showing first {shown})',
  'gitView.trace.ancestorsCount': '{count} ancestors',
  'gitView.trace.inHead': 'Included in current HEAD',
  'gitView.trace.loading': 'Tracing…',
  'gitView.trace.notContained': 'Not on any local branch',
  'gitView.trace.toggle': 'Trace mode',
  ...
  'gitView.integrate.firstStepPrecheck': 'First-step precheck',
  'gitView.integrate.fullSequenceNotSimulated': 'Full sequence not simulated',
  ...
  'chat.statusRow.activity.connecting': 'Connecting',
  'chat.statusRow.activity.retrying': 'Retrying',
  'chat.statusRow.activity.listening': 'Listening',
  'chat.statusRow.activity.working': 'Working',
  'chat.statusRow.activity.searching': 'Searching',
  'chat.statusRow.activity.reasoning': 'Reasoning',
  'chat.statusRow.activity.composing': 'Composing',
  'chat.statusRow.activity.editing': 'Editing',
  'chat.statusRow.activity.orchestrating': 'Delegating task',
