...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.statusRow.activity.connecting': 'Łączenie',
  'chat.statusRow.activity.retrying': 'Ponawianie próby',
  'chat.statusRow.activity.listening': 'Nasłuchiwanie',
  'chat.statusRow.activity.working': 'Praca',
  'chat.statusRow.activity.searching': 'Wyszukiwanie',
  'chat.statusRow.activity.reasoning': 'Rozumowanie',
  'chat.statusRow.activity.composing': 'Tworzenie',
  'chat.statusRow.activity.editing': 'Edycja',
  'chat.statusRow.activity.orchestrating': 'Delegowanie zadania',
  ...
  'gitView.graph.raw': 'Surowy',
  'gitView.graph.patches': 'Poprawki',
  'gitView.graph.syncGroup': 'Synchronizacja ({count})',
  'gitView.graph.stackGroup': 'Stos poprawek ({count})',
  'gitView.graph.stackGroupNamed': 'Stos {name} ({count})',
  'gitView.graph.anchor.mergeBase': 'Baza scalania',
  'gitView.graph.anchor.release': 'Wydanie',
  'gitView.health.baseStale': 'przestarzała baza',
  'gitView.health.behind': 'w tyle',
  'gitView.health.diverged': 'rozbieżny',
  'gitView.health.dormant': 'nieaktywny',
  'gitView.stacks.title': 'Stosy poprawek',
  'gitView.stacks.createWorktreeAria': 'Utwórz worktree dla gałęzi {branch}',
  'gitView.rebasePlan.title': 'Wpływ rebase',
  'gitView.rebasePlan.uniqueCommits': 'Unikalne commity ({count})',
  'gitView.rebasePlan.downstream': 'Dalsze poprawki ({count})',
  'gitView.rebasePlan.dependsOn': '{branch} zależy od {parent}',
  'gitView.rebasePlan.failed': 'Nie udało się wczytać wpływu rebase.',
  'gitView.rebasePlan.warning.downstream': 'Przepisanie tej gałęzi pozostawi dalsze poprawki oparte na starej historii.',
  'gitView.rebasePlan.warning.dirty': 'Przed rebase zatwierdź lub odłóż zmiany w katalogu roboczym.',
  'gitView.rebasePlan.warning.noCommits': 'Ta gałąź nie ma unikalnych commitów do rebase.',
  'gitView.rebasePlan.warning.unrelated': 'Gałąź i cel nie mają wspólnego przodka.',
  'gitView.precheck.checking': 'Sprawdzanie konfliktów…',
  'gitView.precheck.clean': 'Brak konfliktów',
  'gitView.precheck.conflicts': 'Pliki z konfliktami: {count}',
  'gitView.precheck.failed': 'Wstępne sprawdzenie konfliktów nie powiodło się',
  'gitView.health.merged': 'scaleniony',
  'gitView.health.summary': 'rozbieżne: {diverged} · przestarzałe bazy: {baseStale} · nieaktywne: {dormant}',
  'gitView.health.unrelated': 'obca historia',
  'gitView.release.prereleaseLine': 'Wydanie wstępne: {tag}',
  'gitView.release.prereleaseWithStable': 'Wydanie wstępne: {tag} · stabilne: {stableTag}',
  'gitView.release.snapshot': 'Brak tagów wydań — migawka',
  'gitView.release.stableLine': 'Stabilne: {tag} · gałąź +{ahead}/-{behind}',
  'gitView.trace.active': 'Tryb śledzenia włączony — kliknij commit, aby go prześledzić',
  'gitView.trace.clear': 'Wyczyść ślad',
  'gitView.trace.containedIn': 'Zawarty w: {refs}',
  'gitView.trace.ancestorsTruncated': 'Przodków: {count} (wyświetlono pierwsze {shown})',
  'gitView.trace.ancestorsCount': 'Przodków: {count}',
  'gitView.trace.inHead': 'Zawarty w bieżącym HEAD',
  'gitView.trace.loading': 'Śledzenie…',
  'gitView.trace.notContained': 'Nie ma go na żadnej lokalnej gałęzi',
  'gitView.trace.toggle': 'Tryb śledzenia',
  ...
  'gitView.integrate.firstStepPrecheck': 'Wstępne sprawdzenie pierwszego kroku',
  'gitView.integrate.fullSequenceNotSimulated': 'Pełna sekwencja niesymulowana',
