...
export const dict: Record<I18nKey, string> = {
  ...
  'gitView.graph.raw': 'Сирий',
  'gitView.graph.patches': 'Патчі',
  'gitView.graph.syncGroup': 'Синхронізація ({count})',
  'gitView.graph.stackGroup': 'Стек патчів ({count})',
  'gitView.graph.stackGroupNamed': 'Стек {name} ({count})',
  'gitView.graph.anchor.mergeBase': 'База злиття',
  'gitView.graph.anchor.release': 'Реліз',
  "gitView.health.baseStale": "застаріла основа",
  "gitView.health.behind": "позаду",
  "gitView.health.diverged": "розбіжний",
  "gitView.health.dormant": "неактивний",
  "gitView.stacks.title": "Стеки патчів",
  "gitView.stacks.createWorktreeAria": "Створити worktree для {branch}",
  'gitView.rebasePlan.title': 'Вплив rebase',
  'gitView.rebasePlan.uniqueCommits': 'Унікальні коміти ({count})',
  'gitView.rebasePlan.downstream': 'Наступні патчі ({count})',
  'gitView.rebasePlan.dependsOn': '{branch} залежить від {parent}',
  'gitView.rebasePlan.failed': 'Не вдалося завантажити вплив rebase.',
  'gitView.rebasePlan.warning.downstream': 'Перезапис цієї гілки залишить наступні патчі на старій історії.',
  'gitView.rebasePlan.warning.dirty': 'Перед rebase закомітьте або сховайте зміни робочого дерева.',
  'gitView.rebasePlan.warning.noCommits': 'Ця гілка не має унікальних комітів для rebase.',
  'gitView.rebasePlan.warning.unrelated': 'Гілка й ціль не мають спільного предка.',
  'gitView.precheck.checking': 'Перевірка конфліктів…',
  'gitView.precheck.clean': 'Без конфліктів',
  'gitView.precheck.conflicts': 'Конфліктних файлів: {count}',
  'gitView.precheck.failed': 'Не вдалося виконати попередню перевірку конфліктів',
  "gitView.health.merged": "об'єднаний",
  "gitView.health.summary": "розбіжних: {diverged} · застарілих основ: {baseStale} · неактивних: {dormant}",
  "gitView.health.unrelated": "чужа історія",
  "gitView.release.prereleaseLine": "Попередній реліз: {tag}",
  "gitView.release.prereleaseWithStable": "Попередній реліз: {tag} · стабільний: {stableTag}",
  "gitView.release.snapshot": "Немає тегів релізів — знімок",
  "gitView.release.stableLine": "Стабільний: {tag} · гілка +{ahead}/-{behind}",
  "gitView.trace.active": "Режим трасування увімкнено — клацніть коміт, щоб простежити",
  "gitView.trace.clear": "Очистити трасування",
  "gitView.trace.containedIn": "Міститься у: {refs}",
  "gitView.trace.ancestorsTruncated": "Предків: {count} (показано перші {shown})",
  "gitView.trace.ancestorsCount": "Предків: {count}",
  "gitView.trace.inHead": "Включено до поточного HEAD",
  "gitView.trace.loading": "Трасування…",
  "gitView.trace.notContained": "Відсутній на локальних гілках",
  "gitView.trace.toggle": "Режим трасування",
  ...
  "gitView.integrate.firstStepPrecheck": "Попередня перевірка першого кроку",
  "gitView.integrate.fullSequenceNotSimulated": "Повну послідовність не змодельовано",
