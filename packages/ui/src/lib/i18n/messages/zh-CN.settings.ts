...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.visual.background.title': '工作区背景',
  'settings.openchamber.visual.background.description': '在此工作区背后使用本地图片。图片仅保存在此设备上。',
  'settings.openchamber.visual.background.image': '背景图片',
  'settings.openchamber.visual.background.choose': '选择图片',
  'settings.openchamber.visual.background.replace': '替换图片',
  'settings.openchamber.visual.background.remove': '移除',
  'settings.openchamber.visual.background.error': '无法更新工作区背景。',
  'settings.openchamber.visual.background.opacity': '面板不透明度',
  'settings.openchamber.visual.background.readability': '可读性',
  'settings.openchamber.visual.background.readability.weak': '弱',
  'settings.openchamber.visual.background.readability.standard': '标准',
  'settings.openchamber.visual.background.readability.strong': '强',
  'settings.openchamber.visual.background.blur': '模糊面板',
  'settings.openchamber.visual.background.fit': '图片适应方式',
  'settings.openchamber.visual.background.fit.cover': '覆盖',
  'settings.openchamber.visual.background.fit.contain': '完整显示',
  'settings.openchamber.visual.background.position': '位置',
  'settings.openchamber.visual.background.position.center': '居中',
  'settings.openchamber.visual.background.position.top': '顶部',
  'settings.openchamber.visual.background.position.bottom': '底部',
  'settings.openchamber.visual.background.position.left': '左侧',
  'settings.openchamber.visual.background.position.right': '右侧',
