...
export const dict = {
  ...
  'gitView.graph.raw': 'Brut',
  'gitView.graph.patches': 'Correctifs',
  'gitView.graph.syncGroup': 'Synchronisation ({count})',
  'gitView.graph.stackGroup': 'Pile de correctifs ({count})',
  'gitView.graph.stackGroupNamed': 'Pile {name} ({count})',
  'gitView.graph.anchor.mergeBase': 'Base de fusion',
  'gitView.graph.anchor.release': 'Version',
  'gitView.health.baseStale': 'base obsolète',
  'gitView.health.behind': 'en retard',
  'gitView.health.diverged': 'divergé',
  'gitView.health.dormant': 'en sommeil',
  'gitView.stacks.title': 'Piles de correctifs',
  'gitView.stacks.createWorktreeAria': 'Créer un worktree pour {branch}',
  'gitView.rebasePlan.title': 'Impact du rebase',
  'gitView.rebasePlan.uniqueCommits': 'Commits propres ({count})',
  'gitView.rebasePlan.downstream': 'Correctifs en aval ({count})',
  'gitView.rebasePlan.dependsOn': '{branch} dépend de {parent}',
  'gitView.rebasePlan.failed': 'Impossible de charger l’impact du rebase.',
  'gitView.rebasePlan.warning.downstream': 'Réécrire cette branche laissera les correctifs en aval basés sur l’ancien historique.',
  'gitView.rebasePlan.warning.dirty': 'Commitez ou remisez les modifications avant le rebase.',
  'gitView.rebasePlan.warning.noCommits': 'Cette branche n’a aucun commit propre à rebaser.',
  'gitView.rebasePlan.warning.unrelated': 'La branche et la cible n’ont aucun ancêtre commun.',
  'gitView.precheck.checking': 'Vérification des conflits…',
  'gitView.precheck.clean': 'Aucun conflit',
  'gitView.precheck.conflicts': '{count} fichiers en conflit',
  'gitView.precheck.failed': 'Échec de la vérification des conflits',
  'gitView.health.merged': 'fusionné',
  'gitView.health.summary': '{diverged} divergés · {baseStale} bases obsolètes · {dormant} en sommeil',
  'gitView.health.unrelated': 'historie sans lien',
  'gitView.release.prereleaseLine': 'Prépublication : {tag}',
  'gitView.release.prereleaseWithStable': 'Prépublication : {tag} · Stable : {stableTag}',
  'gitView.release.snapshot': 'Aucun tag de version — instantané',
  'gitView.release.stableLine': 'Stable : {tag} · branche +{ahead}/-{behind}',
  'gitView.trace.active': 'Mode trace actif — cliquez un commit pour le tracer',
  'gitView.trace.clear': 'Effacer la trace',
  'gitView.trace.containedIn': 'Contenu dans : {refs}',
  'gitView.trace.ancestorsTruncated': '{count} ancêtres ({shown} premiers affichés)',
  'gitView.trace.ancestorsCount': '{count} ancêtres',
  'gitView.trace.inHead': 'Inclus dans le HEAD actuel',
  'gitView.trace.loading': 'Traçage…',
  'gitView.trace.notContained': 'Sur aucune branche locale',
  'gitView.trace.toggle': 'Mode trace',
  ...
  'gitView.integrate.firstStepPrecheck': 'Pré-vérification du premier pas',
  'gitView.integrate.fullSequenceNotSimulated': 'Séquence complète non simulée',
  ...
  'chat.statusRow.activity.connecting': 'Connexion',
  'chat.statusRow.activity.retrying': 'Nouvelle tentative',
  'chat.statusRow.activity.listening': 'Écoute',
  'chat.statusRow.activity.working': 'En cours',
  'chat.statusRow.activity.searching': 'Recherche',
  'chat.statusRow.activity.reasoning': 'Raisonnement',
  'chat.statusRow.activity.composing': 'Rédaction',
  'chat.statusRow.activity.editing': 'Modification',
  'chat.statusRow.activity.orchestrating': 'Délégation de tâche',
