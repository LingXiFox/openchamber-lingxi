...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.usage.page.state.sub2ApiNoModelTitle': '未選擇 Sub2API 模型',
  'settings.usage.page.state.sub2ApiNoModelDescription': '切換到已在 quota/sub2api.json 配置 Sub2API 額度的模型後，這裡會顯示對應帳戶餘額。',
  ...
  'settings.openchamber.worktrees.list.stackMembershipWithParent': '{group} · 疊放在 {parent} 之上',
  ...
  'settings.openchamber.visual.background.title': '工作區背景',
  'settings.openchamber.visual.background.description': '在此工作區後方使用本機圖片。圖片只會保存在此裝置上。',
  'settings.openchamber.visual.background.image': '背景圖片',
  'settings.openchamber.visual.background.choose': '選擇圖片',
  'settings.openchamber.visual.background.replace': '更換圖片',
  'settings.openchamber.visual.background.remove': '移除',
  'settings.openchamber.visual.background.error': '無法更新工作區背景。',
  'settings.openchamber.visual.background.opacity': '面板不透明度',
  'settings.openchamber.visual.background.readability': '可讀性',
  'settings.openchamber.visual.background.readability.weak': '低',
  'settings.openchamber.visual.background.readability.standard': '標準',
  'settings.openchamber.visual.background.readability.strong': '高',
  'settings.openchamber.visual.background.blur': '模糊面板',
  'settings.openchamber.visual.background.fit': '圖片縮放方式',
  'settings.openchamber.visual.background.fit.cover': '填滿',
  'settings.openchamber.visual.background.fit.contain': '完整顯示',
  'settings.openchamber.visual.background.position': '位置',
  'settings.openchamber.visual.background.position.center': '置中',
  'settings.openchamber.visual.background.position.top': '頂端',
  'settings.openchamber.visual.background.position.bottom': '底端',
  'settings.openchamber.visual.background.position.left': '左側',
  'settings.openchamber.visual.background.position.right': '右側',
