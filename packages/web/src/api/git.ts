...
export const createWebGitAPI = (): GitAPI => ({
  ...
  getBranchCompare: gitApiHttp.getBranchCompare,
  getPatchStacks: gitApiHttp.getPatchStacks,
  getGitTags: gitApiHttp.getGitTags,
  traceCommit: gitApiHttp.traceCommit,
  ...
  planRebase: gitApiHttp.planRebase,
  precheckMerge: gitApiHttp.precheckMerge,
